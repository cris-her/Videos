...
const setResponse = (html, preloadedState, manifest) => {
  ...
  <html>
    <head>
      <link rel="stylesheet" href=${mainStyles} type="text/css">
      <link rel="icon" type="image/png" href="https://firebasestorage.googleapis.com/v0/b/images-6f4f3.appspot.com/o/favicon.png?alt=media&token=911ab74b-ef0f-4eae-ab04-f8c342c4d8f6" />
      <title>Videos</title>
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
    </head>
    <body>
